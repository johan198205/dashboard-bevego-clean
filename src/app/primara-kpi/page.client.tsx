"use client";
import { LeadsBlock } from "./_components/LeadsBlock";
import { SalesBlock } from "./_components/SalesBlock";
import { EfficiencyBlock } from "./_components/EfficiencyBlock";

export default function PrimaraKpiPage() {
  return (
