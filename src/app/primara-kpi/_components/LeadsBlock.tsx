      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="relative">
          ...
          <div className="absolute top-2 right-2">
            <InfoTooltip text="Beräknat från GA4 sessions med 15% konverteringsgrad" />
          </div>
        </div>
        ...
        <div className="relative">
          ...
          />
          <div className="absolute top-2 right-2">
            <InfoTooltip text="Beräknat från GA4 sessions med 8% konverteringsgrad" />
          </div>
        </div>
        ...
        <div className="relative">
          ...
          />
          <div className="absolute top-2 right-2">
            <InfoTooltip text="Beräknat från GA4 sessions med 12% konverteringsgrad" />
          </div>
        </div>
        ...
        <div className="relative">
          ...
          />
          <div className="absolute top-2 right-2">
            <InfoTooltip text="Beräknat från GA4 engaged sessions med 25% konverteringsgrad" />
          </div>
        </div>
      </div>
        ...
        <div className="card">
          <div className="mb-2 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <InfoTooltip text="Tidsserie för leads baserat på GA4 sessions-data" />
            </div>
          </div>
          {chartData.length > 0 ? (
